...
const Discover = () => {
  ...
  return (
    <div className="pb-20 min-h-screen animate-fade-in">
      ...
      <div className="px-4 py-3 sticky top-0 z-10 bg-black/80 backdrop-blur-sm shadow-sm pt-24">
        <div className="relative">
          <Input
            type="text"
            placeholder="Search stocks, ETFs, crypto..."
            className="pr-10 bg-gray-800/50 border-gray-700 text-white placeholder:text-gray-400"
            value={searchQuery}
